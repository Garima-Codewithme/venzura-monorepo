...
const INPUT_FILE = path.join(ROOT, 'src', 'data', 'generated', 'veterinary-products.json')

if (!fs.existsSync(INPUT_FILE)) {
  console.error(`Veterinary JSON not found: ${INPUT_FILE}`)
  process.exit(1)
}
...
async function run() {
  ...
  console.log(`\nDone. Imported ${products.length} veterinary products.`)
}
